...
class ProductItem extends HTMLElement {
  ...
  constructor(){
    ...
    `
    this.shadowRoot.appendChild(shadowRoot.content.cloneNode(true));
  ...
  */
  ...
  attributeChangedCallback(attrName, oldVal, newVal){
    ...
    // (3A) p txt - title
      ...
      console.log(list.childNodes[3]); // p title tag
      //console.log(list.childNodes[4]); #text
      console.log(list.childNodes[5]); // p price tag
      //console.log(list.childNodes[6]); #text
      */
